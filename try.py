...
# By 0verflowSec aka xMs_UwU_sMx
# Encrypt Algorithm = a ^ b
# Decrypt Algorithm = c - b % c
...
newfile = open('output.py', 'w')
newfile.write(payload)


# Testing new idea place
""" a = ord('1')
b = 256
c = a ^ b
print(f'Ord : {a}')
